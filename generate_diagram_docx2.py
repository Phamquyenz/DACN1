...
def download_diagram_post(puml_text, filename):
    url = "https://kroki.io"
    payload = json.dumps({
    ...
    try:
        ...
        # Fallback to plantuml.com with custom encoder if needed, but Kroki POST usually works.
        pass
...
AD --> UC11
@enduml"""
    download_diagram_post(puml_usecase, "uc_diag.png")
...
stop
@enduml"""
    download_diagram_post(puml_activity, "act_diag.png")
...
@enduml"""
    download_diagram_post(puml_sequence, "seq_diag.png")
...
V "1" -- "0..*" O : applied in >
@enduml"""
    download_diagram_post(puml_erd, "erd_diag.png")
    ...
    doc.save(r'C:\xampp\htdocs\The Stationery Muse\Báo_Cáo_Bản_Cuối_Cùng_Kèm_Sơ_Đồ.docx')
