            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.vouchers.store') }}" method="POST">
                        ...
                        <div class="mb-4" x-data="{ type: 'percent' }">
                        ...
                        <div class="mb-4 bg-gray-50 p-4 rounded border">
                            ...
                            <div class="flex flex-wrap -mx-2 mb-4">
                                ...
                                <div class="w-full md:w-1/2 px-2">
                                    ...
                                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline border-blue-300" type="number" name="reward_condition_amount" value="{{ old('reward_condition_amount') }}" min="0" placeholder="VD: 500000 -> Mua 500k tự tặng mã này">
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap -mx-2">
                                ...
                                <div class="w-full md:w-1/2 px-2 flex items-center mt-4 md:mt-0">
                                    <label class="flex items-center text-gray-700 text-sm font-bold cursor-pointer">
                                        <input type="checkbox" name="is_public" value="1" class="transform scale-150 mr-3 text-green-500" {{ old('is_public', true) ? 'checked' : '' }}>
                        ...
                        <div class="mb-4 flex flex-wrap -mx-2">
                            <div class="w-full md:w-1/2 px-2 mb-4 md:mb-0">
                                <label class="block text-gray-700 text-sm font-bold mb-2">Giới hạn số lượng lưu/dùng (Tùy chọn)</label>
